  ...
  return (
    <section className="filosofia-container">
      <div className="filosofia-content">
        ...
        <p>
          En nuestro estudio, te enseñamos a escuchar al árbol, entendiendo que
          cada corte y cada alambrado debe tener un propósito. Buscamos el
          equilibrio perfecto entre la intervención humana y la expresión
